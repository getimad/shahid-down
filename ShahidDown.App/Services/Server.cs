namespace ShahidDown.App.Services
{
    ...
    {
        private static readonly string _baseUrl = "https://ww.animeluxe.com";

        internal static string GetSearchUrl(string query)
        {
            return $"{_baseUrl}/anime?s={query}";
        }
        ...
        {
            return $"{_baseUrl}/episodes/{animeSubTitleUrl}-%d8%a7%d9%84%d8%ad%d9%84%d9%82%d8%a9-{episode}";
        }
    }
}
